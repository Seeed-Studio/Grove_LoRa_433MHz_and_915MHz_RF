...
RHRouter manager(driver, ROUTER3_ADDRESS);
...
void setup() 
{
    ...
    manager.addRouteTo(ROUTER1_ADDRESS, ROUTER2_ADDRESS);
    manager.addRouteTo(ROUTER2_ADDRESS, ROUTER2_ADDRESS);
    manager.addRouteTo(ROUTER4_ADDRESS, ROUTER4_ADDRESS);
}

uint8_t data[] = "Hello World!";
uint8_t back[] = "And hello back to you from router 3";
